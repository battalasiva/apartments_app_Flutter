      ...
      body: BlocConsumer<AddServiceProviderBloc, AddServiceProviderState>(
        ...
        builder: (context, state) {
          ...
          return serviceProviders.isEmpty
              ?  Center(child: Text("Service Providers Not Available",style: txt_14_400.copyWith(color: AppColor.black1),))
              : ListView.builder(
  ...
  child: Padding(
    ...
    child: Row(
      ...
      children: [
          ...
          children: [
            Row(
              children: [
                ...
                if (serviceProviders[index].isDefaultPartner!) 
                  Container(
                    width: 20,
                    height: 20,
        ...
        DialerButton(phoneNumber: provider?.primaryContact ?? ""),
      ],
    ),
  ),
);
