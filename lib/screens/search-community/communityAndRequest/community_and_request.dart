      ...
      listener: (context, state) {
        ...
        if (state is SplashApartmentNotFound) {
          ...
          setState(() {
            ...
            isOwner = (state.user.user.roles.contains('ROLE_FLAT_OWNER') == true);
      ...
      child: RefreshIndicator(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: (isCurrentFlat || isAdmin) ? Builder(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('Hello, $name!',
                        style: txt_17_800.copyWith(color: AppColor.primaryColor1)),
                  ),
                  const SizedBox(height: 5),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 8),
                    child: Text('What Do You Want?',
                        style: txt_14_400.copyWith(color: AppColor.primaryColor1)),
                  ),
                      ...
                      _card(
                        ...
                        () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => SearchCommunity(source: widget.source,)));
                        },
                      ),
                      _card(
                        request,
