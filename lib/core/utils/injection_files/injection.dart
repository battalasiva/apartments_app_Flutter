...
class Injection {
  ...
  late final AddCreditMaintainanceRepositoryImpl addCreditMaintainanceRepository;
  ...
  late final AddPrepaidMeterConsumptionUseCase addPrepaidMeterConsumptionUseCase;
  ...
  late final GetSingleFlatLastAddedConsumptionUseCase getSingleFlatConsumptionUsecase;
  ...
  Future<void> init() async {
   ...
   userRepository = UserRepositoryImpl(userDataSource: userDataSource);
    final prepaidmeterslistDatasource = PrepaidMeterListDataSource(apiClient: apiClient);
    final prepaidMeterListRepositoryImpl = PrepaidMeterListRepositoryImpl(datasource: prepaidmeterslistDatasource);
    fetchPrepaidMetersUseCase = FetchPrepaidMetersListUseCase(repository: prepaidMeterListRepositoryImpl);
    ...
    useDuesRepository =
      UserDuesRepositoryImpl(dataSource: userduesDataSource);
     final adminsDataSource = AdminsDataSource(apiClient: apiClient);
     adminsRepository =
      AdminsRepositoryImpl(adminsDataSource: adminsDataSource);
    ...
    final reassignComplaintDataSource =
     ...
     reassignComplaintRepository =
      ReassignComplaintRepositoryImpl(dataSource: reassignComplaintDataSource);
    final ownersDataSource = OwnersDataSource(apiClient: apiClient);
     ownersRepository =
      OwnersRepositoryImpl(remoteDataSource: ownersDataSource);
  ...
  final addDebitMaintainenceRepositoryImpl = AddDebitMaintainanceRepositoryImpl(
  ...
  deleteCreditHistoryUseCase =
      DeleteCreditHistoryUseCase(repository: deleteCreditHistoryRepositoryImpl);
  ...
  final lastAddedConsumptionRepositoryImpl = LastAddedConsumptionRepositoryImpl(
  ...
  final myRequestsRepositoryImpl =
   ...
   myRequestsUseCase =
      MyRequestsUseCase(repository: myRequestsRepositoryImpl);
  ...
  final postMeterReadingRepositoryImpl =
      PostMeterReadingsRepositoryImpl(dataSource: postMeterReadingsDataSource);
  ...
  final getSingleFlatConsumptionDatasource = GetSingleFlatConsumptionDataSource(apiClient);
  final getSingleFlatConsumptionRepositoryImpl =
       GetSingleFlatConsumptionRepositoryImpl(getSingleFlatConsumptionDatasource);
  getSingleFlatConsumptionUsecase = GetSingleFlatLastAddedConsumptionUseCase(getSingleFlatConsumptionRepositoryImpl);
  allFlatsUsecase = AllFlatsUsecase(repository: AllFlatsRepositoryImpl(datasource: AllFlatsDatasource(apiClient: ApiClient())));
  final addServiceProviderDatasource = AddServiceProviderDataSource(apiClient);
  final addServiceProviderRepositoryImpl =
       AddServiceProviderRepositoryImpl(addServiceProviderDatasource);
  addServiceProviderUsecase = AddServiceProviderUseCase(addServiceProviderRepositoryImpl);
  final getServiceProviderDatasource = GetServiceProvidersListDataSource(apiClient);
  final getServiceProviderRepositoryImpl =
       GetServiceProvidersListRepositoryImpl(getServiceProviderDatasource);
  getServiceProviderUsecase = GetServiceProvidersListUseCase(getServiceProviderRepositoryImpl);
  ...
  final handleGuestStatusUsecaseDataSource = HandleGuestStatusDataSource(apiClient);
  final handleGuestStatusRepositoryImpl =
       HandleGuestStatusRepositoryImpl(handleGuestStatusUsecaseDataSource);
  handleGuestStatusUsecase = HandleGuestStatusUsecase(handleGuestStatusRepositoryImpl);
  ...
  updateGuestStatusUseCase = UpdateGuestStatusUseCase(updateGuestStatusRepositoryImpl);
  configuredVisitorsUsecase = ConfiguredVisitorsUsecase(repository: ConfiguredVisitorsRepositoryimpl(datasource: 
  ConfiguredVisitorsDatasource(apiClient: ApiClient())));
  }
}